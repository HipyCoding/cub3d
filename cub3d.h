...
/*   Updated: 2025/04/11 23:11:38 by candrese         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_vertical_line(t_cub3d *c, int x, mlx_texture_t *texture,
				int tex_x);
...
// void		draw_line(t_cub3d *c, int x1, int y1, int x2, int y2,
//				uint32_t color);
// void		draw_rectangle(t_cub3d *c, int x, int y, int width,
